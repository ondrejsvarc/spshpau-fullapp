...
import { createOrUpdateArtistProfile } from '../services/api';
...
function CreateArtistProfilePage() {
    ...
    const handleSubmit = async (event) => {
        ...
        setError(null);
        try {
            await createOrUpdateArtistProfile(formData);
            if (refreshAppUser) {
                await refreshAppUser();
            }
            navigate('/account/artist-profile');
        } catch (err) {
        ...
        <Container maxWidth="sm">
            <Paper elevation={3} sx={{ p: { xs: 2, sm: 4 }, mt: 4 }}>
                ...
                <Typography variant="body2" color="textSecondary" align="center" sx={{mb: 2}}>
                    Start by selecting your experience level. Other details can be added now or later.
                </Typography>
